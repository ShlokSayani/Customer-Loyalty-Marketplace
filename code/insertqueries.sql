...
insert into Customer(customer_id, customer_name, phone_number, customer_address, customer_password) values('C0001','Peter Parker','8636368778','20 Ingram Street, NY','c0001pwd');
insert into Customer(customer_id, customer_name, phone_number, customer_address, customer_password) values('C0002','Steve Rogers','8972468552','569 Leaman Place, NY','c0002pwd');
insert into Customer(customer_id, customer_name, phone_number, customer_address, customer_password) values('C0003','Diana Prince','8547963210','1700 Broadway St, NY','c0003pwd');
insert into Customer(customer_id, customer_name, phone_number, customer_address, customer_password) values('C0004','Billy Batson','8974562583','5015 Broad St, Philadelphia, PA','c0004pwd');
insert into Customer(customer_id, customer_name, phone_number, customer_address, customer_password) values('C0005','Tony Stark','8731596464','10880 Malibu Point, CA','c0005pwd');
