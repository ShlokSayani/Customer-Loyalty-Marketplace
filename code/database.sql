...
begin
    select TO_NUMBER(customer_points) into currentpoints from Customer_program where customer_id = :new.customer_id AND loyalty_id = :new.loyalty_id;
    update Customer_program set customer_points = givesu(currentpoints, TO_NUMBER(:new.redeem_points)) where customer_id = :new.customer_id and loyalty_id = :new.loyalty_id;
end;
/
